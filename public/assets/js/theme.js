...
function layout_theme_contrast_change(value) {
    ...
    var newActiveButton = document.querySelector(
        `.theme-contrast .btn[data-value='${value}']`
    );
    if (newActiveButton) {
...
function layout_change(layout) {
    ...
    var defaultBtnControl = document.querySelector(
        '.theme-layout .btn[data-value="default"]'
    );
    ...
    if (layout === "dark") {
        ...
        updateLogo(
            ...
            "/assets/images/logo/logo_dark_mode.png"
        );
        updateLogo(
        ...
        updateLogo(
            ".pc-sidebar .m-header .logo-lg",
            "/assets/images/logo/logo_light_mode.png"
        );
        updateLogo(
            ".navbar-brand .logo-lg",
            "/assets/images/logo/logo_light_mode.png"
    ...
    if (contentElement && footerWrapper) {
        ...
        if (value === "true") {
            ...
            var activeBtn = document.querySelector(
                ".theme-container .btn.active"
            );
            if (activeBtn) {
                activeBtn.classList.remove("active");
            }
            var newActiveBtn = document.querySelector(
