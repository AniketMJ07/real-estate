...
<?php $__env->startSection('main_content'); ?>
        ...
        <div class="container title">
            <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
                <div class="col-md-8 col-xl-6">
                    ...
                    <p class="mb-0">Explore the features of <?php echo e(config('setting.site_name')); ?></p>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 position-relative wow fadeInRight" data-wow-delay="0.4s">
                    <div class="owl-carousel owl-theme screen-slide img-app-moke">
                        <div class="item" data-hash="app_1">
                            <img src="<?php echo e(asset('assets/images/landing/dash/dash-min.png')); ?>" alt="img"
                                class="img-fluid rounded" />
                        </div>
                        <div class="item" data-hash="app_2">
                            <img src="<?php echo e(asset('assets/images/landing/dash/live-min.png')); ?>" alt="img"
                                class="img-fluid rounded" />
                        </div>
                        <div class="item" data-hash="app_3">
                            <img src="<?php echo e(asset('assets/images/landing/dash/qr-report-min.png')); ?>" alt="img"
                                class="img-fluid rounded" />
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="col-md-4 text-md-end">
                    <a class="btn btn-lg btn-primary m-1" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        href="<?php echo e(route('register')); ?>" target="_blank" title="No credit card required">Start 14-day trial
                        today!</a>
                </div>
            </div>
        </div>
    ...
    <section class="support-team-block d-none">
        <div class="container title">
            <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
                <div class="col-md-8 col-xl-6">
                    <h2 class="mb-3"> They <span class="text-primary">love</span> <?php echo e(config('setting.site_name')); ?>, Now
                        its your turn 😍 </h2>
                    <!-- prettier-ignore -->
