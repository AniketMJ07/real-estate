            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext" data-i18n="Form Elements">Forms Elements</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext" data-i18n="Form Plugins">Forms Plugins</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                        <li class="pc-item pc-hasmenu">
                            <a class="pc-link" href="#">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext" data-i18n="Form Layouts">File upload</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext" data-i18n="Vanilla table">Vanilla Table</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext" data-i18n="DT extensions">DT extensions</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext" data-i18n="Ecommerce">E-commerce</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext" data-i18n="User">Users</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext" data-i18n="Authentication">Authentication</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                        <li class="pc-item pc-hasmenu">
                            <a href="#!" class="pc-link">
                            ...
                            <ul class="pc-submenu">
                                ...
                                <li class="pc-item"><a class="pc-link" target="_blank"
                                        ...
                                        Password</a></li>
                                <li class="pc-item"><a class="pc-link" target="_blank"
                                        href="../pages/check-mail-v1.html" data-i18n="Check Mail">check mail</a></li>
                                <li class="pc-item"><a class="pc-link" target="_blank"
                        ...
                        <li class="pc-item pc-hasmenu">
                            ...
                            <ul class="pc-submenu">
                                ...
                                <li class="pc-item"><a class="pc-link" target="_blank"
                                        href="../pages/check-mail-v2.html" data-i18n="Check Mail">check mail</a></li>
                                <li class="pc-item"><a class="pc-link" target="_blank"
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item pc-hasmenu">
                            ...
                            <ul class="pc-submenu">
                                <li class="pc-item"><a class="pc-link" target="_blank"
                                        href="../pages/coming-soon-v1.html" data-i18n="Coming-Soon 1">Coming soon 1</a>
                                </li>
                                <li class="pc-item"><a class="pc-link" target="_blank"
                                        href="../pages/coming-soon-v2.html" data-i18n="Coming-Soon 2">Coming soon 2</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext" data-i18n="Price">Price</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                ...
                <li class="pc-item"><a href="../index.html" class="pc-link" target="_blank"><span class="pc-micon">
                            <svg class="pc-icon">
